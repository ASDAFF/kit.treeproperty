...
if(class_exists("newsite.treeproperty")) return;
Class newsite_treeproperty extends CModule
{
    var $MODULE_ID = "newsite.treeproperty";
    var $MODULE_VERSION;
    ...
    function newsite_treeproperty()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage("NEWSITE_TREEPROPERTY_INSTALL_NAME");
        $this->MODULE_DESCRIPTION = Loc::getMessage("NEWSITE_TREEPROPERTY_INSTALL_DESCRIPTION");
        $this->PARTNER_NAME = Loc::getMessage("NEWSITE_TREEPROPERTY_INSTALL_COPMPANY_NAME");
